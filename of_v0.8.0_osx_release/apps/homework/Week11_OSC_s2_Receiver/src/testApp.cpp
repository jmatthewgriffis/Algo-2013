...
void testApp::setup(){
    ...
    ofSetWindowPosition( ( ofGetScreenWidth() - ( ofGetWidth() * 2.0 ) ) / 2.0 + ofGetWidth(), ( ofGetScreenHeight() - ( ofGetHeight() * 2.0 ) ) / 2.0 ); // All four windows will be centered together, this one in the upper-right.
