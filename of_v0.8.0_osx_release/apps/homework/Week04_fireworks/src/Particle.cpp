...
void Particle::setup( ofVec2f rVel ){
    ...
    ofSetColor(ofRandom(0,255), ofRandom(0,255), ofRandom(0,255)); // For some reason, every batch of particles is color-consistent within the batch.
};
...
//    ofSetColor(ofRandom(0,255), ofRandom(0,255), ofRandom(0,255)); // Putting this in the draw makes the color change every frame.
